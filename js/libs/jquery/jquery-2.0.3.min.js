...
(function(e, undefined) {
    ...
    t = x(o), function(e, undefined) {
        ...
        function wt(e) {
            ...
            for (; o > l; l++)if (n = i.relative[e[l].type]) {
                f = [yt(vt(f), n)];
            } else {
    ...
    x.fn.extend({attr: function(e, t) {
        ...
        if (u) {
            for (t = (e || "").match(w) || []; a > s; s++)if (n = this[s], r = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(W, " ") : " ")) {
                o = 0;
    ...
    x.event = {global: {}, add: function(e, t, n, i, o) {
        ...
        if (a && u.nodeType && (!e.button || "click" !== e.type)) {
            for (; u !== this; u = u.parentNode || this)if (u.disabled !== !0 || "click" !== e.type) {
    ...
    function fn(e, t, n, r) {
        ...
        while (o)if (e.responseFields[o] && (n[e.responseFields[o]] = t), !u && r && e.dataFilter && (t = e.dataFilter(t, e.dataType)), u = o, o = c.shift()) {
            if ("*" === o) {
                ...
                if (s = l[u + " " + o] || l["* " + o], !s) {
                    for (i in l)if (a = i.split(" "), a[1] === o && (s = l[u + " " + a[0]] || l["* " + a[0]])) {
