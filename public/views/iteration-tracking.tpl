<div ng-controller="IterationStatusController">
    ...
    <form role="form" class="form-inline" id="release-iteration-breadcrumb" novalidate>
        ...
        <div class="form-group">
            <select class="form-control input-sm" ng-model="iteration" ng-options="key as value for (key, value) in iterations" ng-change="changeIteration()" title="Change iteration"></select>
        </div>
    </form>
